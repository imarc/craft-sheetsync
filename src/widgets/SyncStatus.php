...
namespace imarc\csvsync\widgets;

use imarc\csvsync\CsvSync;
use imarc\csvsync\assetbundles\syncstatuswidget\SyncStatusWidgetAsset;
 ...
 * @since     1.0.0
 */
class SyncStatus extends Widget
{
    ...
    {
        return Craft::t('csv-sync', 'SyncStatus');
    }
    ...
    {
        return Craft::getAlias("@imarc/csvsync/assetbundles/syncstatuswidget/dist/img/SyncStatus-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'csv-sync/_components/widgets/SyncStatus_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(SyncStatusWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'csv-sync/_components/widgets/SyncStatus_body',
            [
